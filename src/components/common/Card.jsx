export default function Card({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-line bg-surface p-8 shadow-panel">
      ...
      <span
        aria-hidden
        className="corner-bloom pointer-events-none absolute -right-24 -top-24 h-52 w-52 rounded-full bg-gradient-to-br from-indigo-400 to-fuchsia-500 opacity-[0.12] blur-2xl"
      />
